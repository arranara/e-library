<marquee>Selamat Datang Dihalaman Utama Aplikasi Perpustakaan SMK Antara Palembang</marquee>
...
<div class="col-md-3 col-sm-6 col-xs-6">           
			...
			<div class="panel panel-back noti-box">
                ...
                <a href="?page=catatan" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
             </div>
		     </div>
			</div>